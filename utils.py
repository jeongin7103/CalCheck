...
print("label map:",label_map) # 'mango': 1
print("label color map",label_color_map) # 'mango': '#e6194b'
print("reverse label map",rev_label_map) # 1:'mango'
...
def save_checkpoint(epoch, model, optimizer):
    state = {'epoch': epoch,
             'model': model,
             'optimizer': optimizer}
    checkpoint_dir = '/content/drive/MyDrive/SSD_detection/checkpoints'
    filename = os.path.join(checkpoint_dir, f'checkpoint_ssd300_epoch_{epoch}.pth.tar')
